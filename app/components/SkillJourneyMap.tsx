    ...
    return (
        <div style={{
            ...
            <div className="relative">
                <svg viewBox="0 0 1400 550" className="w-full h-auto">
                    <defs>
                        {/* Grid pattern */}
                        ...
                        {/* Glow effects for each category */}
                        <filter id="glow">
                    ...
                    {/* Background grid */}
                    <rect width="1400" height="550" fill="url(#grid)" />

                    {/* Category zones - subtle background areas */}
                    <g opacity="0.1">
                        {/* Frontend Zone */}
                ...
                {/* Skill details panel */}
                {selectedSkill !== null && (
                    <div className="absolute top-4 right-4 bg-gray-900 border border-gray-700 rounded-xl p-6 w-80 shadow-2xl animate-fade-in">
                        {skills
